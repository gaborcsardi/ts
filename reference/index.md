...
- See [‘About ts’](https://gaborcsardi.github.io/ts/reference/about.md)
  for an overview of ts.
...
- [`ts_tree_mark_selection1()`](https://gaborcsardi.github.io/ts/reference/ts_tree_mark_selection1.md)
  : TODO
- [`ts_tree_select1(`*`<ts_tree.ts_tree_selector_default>`*`)`](https://gaborcsardi.github.io/ts/reference/ts_tree_select1.md)
  [`ts_tree_select1(`*`<ts_tree.NULL>`*`)`](https://gaborcsardi.github.io/ts/reference/ts_tree_select1.md)
  [`ts_tree_select1(`*`<ts_tree.ts_tree_selector_ids>`*`)`](https://gaborcsardi.github.io/ts/reference/ts_tree_select1.md)
  [`ts_tree_select1(`*`<ts_tree.ts_tree_selector_tsquery>`*`)`](https://gaborcsardi.github.io/ts/reference/ts_tree_select1.md)
  [`ts_tree_select1(`*`<ts_tree.character>`*`)`](https://gaborcsardi.github.io/ts/reference/ts_tree_select1.md)
  [`ts_tree_select1(`*`<ts_tree.integer>`*`)`](https://gaborcsardi.github.io/ts/reference/ts_tree_select1.md)
  [`ts_tree_select1(`*`<ts_tree.numeric>`*`)`](https://gaborcsardi.github.io/ts/reference/ts_tree_select1.md)
  [`ts_tree_select1(`*`<ts_tree.ts_tree_selector_regex>`*`)`](https://gaborcsardi.github.io/ts/reference/ts_tree_select1.md)
  [`ts_tree_select1(`*`<ts_tree.logical>`*`)`](https://gaborcsardi.github.io/ts/reference/ts_tree_select1.md)
